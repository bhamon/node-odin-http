...
/**
	...
	@param {Date} p_creationDate		Creation date.
	@param {Date} p_lastAccessDate		Last access date.
	@param {String[]} p_rights			Rights list.
	@param {Object} [p_data={}]			Extra data.
*/
function Session(p_token, p_creationDate, p_lastAccessDate, p_rights, p_data) {
	var args = lib.odin.util.validate({
		token:p_token,
		creationDate:p_creationDate,
		lastAccessDate:p_lastAccessDate,
		rights:p_rights,
		data:p_data
	}, {
		token:lib.deps.joi.string().required().min(1),
		creationDate:lib.deps.joi.date().required(),
		lastAccessDate:lib.deps.joi.date().required(),
		rights:lib.deps.joi.array().required().items(
	...
	*/
	...
	/**
		...
		@desc				Unique token.
	*/
	Object.defineProperty(this, 'token', {enumerable:true, value:p_config.token});
	...
	/**
		...
		@desc				Creation date.
	*/
	Object.defineProperty(this, 'creationDate', {enumerable:true, value:p_config.creationDate});

	/**
		@member {Date}		module:odin/http.Session#lastAccessDate
		@desc				Last access date.
	*/
	Object.defineProperty(this, 'lastAccessDate', {enumerable:true, writable:true, value:p_config.lastAccessDate});

	/**
		@member {Object}	module:odin/http.Session#data
		@desc				Extra data.
	*/
	Object.defineProperty(this, 'data', {enumerable:true, value:p_config.data});

	this.addRights(p_config.rights);
};
